...
const TONotificationDropdown = ({ onClose, onNotificationRead }) => {
  ...
  const handleNotificationClick = async (notificationId) => {
    ...
    navigate(`/to/notices?noticeId=${encodeURIComponent(notificationId)}`);
  };
...
export default TONotificationDropdown;
